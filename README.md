...
### Assignment Summary: 
#### Homework assignments consisted of two or three primary tasks centered on the content covered during lectures. Projects consisted of focused tasks centered on the application of learned material to a real-world problem. Homeworks 1-5 focused on an introduction to python computations, numerical methods in python, regression and correlation statistics, molecular simulation, and monte carlo simulations. Projects 1 and 2 focused on grand canonical monte carlo simulations of competitive adsorption and molecular dynamics simulations of a polymer chain respectively.
